...
const ProjectCard = (props) => {
  ...
  return (
    <div className={`box${show ? " slideFadeIn" : ""}`} ref={ref}>
      <div
        className="flex align-center thumbnail"
        onClick={() => openWorkInNewTab(hostUrl)}
      >
        {state ? (
          state.hasError ? (
            <div className="flex justify-center align-center max">
              {" "}
              Couldn't load image...
            </div>
          ) : (
